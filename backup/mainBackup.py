...
if __name__ == "__main__":
    ...
    if args.labpath != 'null':
        ...
        print("Before creating module\n")
        print(torch.cuda.memory_summary())
        module = ContrastLearn(hparams)
        print("After creating module\n")
        print(torch.cuda.memory_summary())
    trainer = pl.Trainer(gpus=args.gpus, max_epochs=hparams.epochs)	# devices -> gpus
    print("After creating trainer\n")
    print(torch.cuda.memory_summary())
